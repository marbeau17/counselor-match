...
export default async function WalletPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">ポイントウォレット</h1>
        <p className="text-gray-500 mt-1">セッション料金に使える前払いポイント</p>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          {transactions.length > 0 ? (
                  ...
                  {transactions.map((tx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-3 text-gray-500">{tx.note ?? ""}</td>
                      </tr>
                    )
                  })}
                </tbody>
            ...
            <p className="text-gray-400 text-center py-8">取引履歴はありません</p>
          )}
        </CardContent>
      </Card>
    </div>
