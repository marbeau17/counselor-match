...
import { Layers, Sparkles, Users, BookOpen, ArrowRight } from "lucide-react"
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="text-center max-w-3xl mx-auto mb-16">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4">私たちについて</h1>
      ...
      <div className="mb-16">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-3">ホリスティック心理学</h2>
          <p className="text-gray-500 dark:text-gray-400">4層モデルによる統合的アプローチ</p>
        </div>
      ...
      <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-8 md:p-12 mb-16">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">魂鏡の法則</h2>
      ...
      {/* Features */}
      <div className="mb-16">
        <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 text-center mb-10">プラットフォームの特徴</h2>
      ...
      {/* Company */}
      <div className="mb-16">
        <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 text-center mb-10">運営会社</h2>
            ...
            <dl className="space-y-4">
              {[
                ...
                <div key={label} className="flex flex-col sm:flex-row sm:gap-4">
                  <dt className="text-sm font-medium text-gray-500 dark:text-gray-400 sm:w-32 shrink-0">{label}</dt>
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">あなたの旅路を始めましょう</h2>
        <p className="text-gray-500 dark:text-gray-400 mb-6">まずはカウンセラーを探してみてください</p>
